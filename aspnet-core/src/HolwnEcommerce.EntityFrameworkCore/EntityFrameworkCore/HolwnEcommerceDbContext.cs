...
using HolwnEcommerce.Promotions;
...
public class HolwnEcommerceDbContext :
    AbpDbContext<HolwnEcommerceDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public HolwnEcommerceDbContext(DbContextOptions<HolwnEcommerceDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(HolwnEcommerceConsts.DbTablePrefix + "YourEntities", HolwnEcommerceConsts.DbSchema);
