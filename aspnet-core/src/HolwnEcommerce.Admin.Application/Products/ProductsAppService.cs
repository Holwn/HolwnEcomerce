...
namespace HolwnEcommerce.Admin.Products
{
        ...
        CreateUpdateProductDto>, IProductsAppService
    {
        ...
        public override async Task<ProductDto> UpdateAsync(Guid id, CreateUpdateProductDto input)
        {
            ...
            if (product == null)
                throw new BusinessException(HolwnEcommerceDomainErrorCodes.ProductIsNotExists);
        ...
        public async Task<ProductAttributeValueDto> AddProductAttributeAsync(AddUpdateProductAttributeDto input)
        {
            ...
            if (attribute == null)
                throw new BusinessException(HolwnEcommerceDomainErrorCodes.ProductAttributeIdIsNotExists);
            ...
            switch (attribute.DataType)
            {
                case AttributeType.Date:
                    ...
                    {
                        throw new BusinessException(HolwnEcommerceDomainErrorCodes.ProductAttributeValueIsNotValid);
                    }
        ...
        public async Task<ProductAttributeValueDto> UpdateProductAttributeAsync(Guid id, AddUpdateProductAttributeDto input)
        {
            ...
            switch (attribute.DataType)
            {
                ...
                case AttributeType.Text:
                    ...
                    productAttributeText.Value = input.VarcharValue;
                    await _productAttributeTextRepository.InsertAsync(productAttributeText);
                    break;
            }
            await UnitOfWorkManager.Current.SaveChangesAsync();
