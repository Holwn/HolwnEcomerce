...
public static class HolwnEcommerceAdminPermissions
{
    public const string SystemGroupName = "HolwnEcomAdminSystem";
    public const string CatalogGroupName = "HolwnEcomAdminCatalog";
